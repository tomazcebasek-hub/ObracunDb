...
- When DevExpress API details are unclear, check the DevExpress documentation instead of running terminal/inspection commands.
...
- When user says 'naredi' or gives a direct implementation request, proceed directly with code changes without narrating intent or asking for confirmation.